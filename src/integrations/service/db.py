...
def save_order(validated_order, validated_products_items):
    serializer = OrderSerializer(data=validated_order)
    print(serializer)
    ...
    for product in validated_products_items:
        ...
        serializers_product = ProductSerializer(data=new_data)
